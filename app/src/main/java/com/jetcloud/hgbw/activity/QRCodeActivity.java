...
public class QRCodeActivity extends BaseActivity {
    ...
    private FooddOutBean fooddOutBean;
    private String time;
    ...
    protected void loadData() {
        Intent i = getIntent();
        if (i.hasExtra(HgbwStaticString.FOOD_OUT) && i.hasExtra(ORDER_NUM)) {
            fooddOutBean = (FooddOutBean) i.getSerializableExtra
...
//                tv_showResult.setText(result);
    ...
    public void make() {
        ...
        Gson gson = new Gson();
        String jsonData = gson.toJson(fooddOutBean);
        ...
        try {
            ...
            fooddOut.put("mechine_number", app.getGroups().get(0).getNumber());
